...
const getJuegos = () => {
  fetch('https://gamespractica8-apirestfile.vercel.app/api/v1/juegos')
    .then((res) => res.json())
    .then((juegos) => {
      printJuegos(juegos)
    })
...
const login = (e) => {
  ...
  axios
    .post(
      'https://gamespractica8-apirestfile.vercel.app/api/v1/users/login',
      objetoEnviar
    )
...
const publicarJuego = (e) => {
  ...
  axios
    .post(
      'https://gamespractica8-apirestfile.vercel.app/api/v1/juegos',
      formData,
      {
        headers: {
